...
<div class="page-wrapper">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-subtitle">View All Employees</h6>
                ...
                <div class="table-responsive m-t-40">
                        ...
                        <tr>
                            ...
                            <td>{{$employee->company ? $employee->company->name : "This employee bysthbl"}}</td>

                          
                            <td>
    
                                <button  class="btn btn-group-sm btn-link"><a href="{{route('admin.employees.edit', $employee->id)}}"><i class="fa fa-edit waves-effect"></i>  </button>
    
                                {!! Form::open(['method'=>'DELETE', 'action'=> ['EmployeeController@destroy', $employee->id],'onsubmit' => 'return ConfirmDelete()']) !!}
